  ...
  var body: some View {
    ...
    Form {
      ...
      Section("Sliders") {
        ...
        SettingsCaption("Apple and built-in displays already have a brightness slider in Control Center.")
        ...
        SettingsCaption("DDC-controlled displays only, and results vary by monitor.")
      }
      ...
      Section("Slider appearance") {
        ...
        // drag.
        SettingsCaption("Snapping pulls a slider to the nearest 25%, 50%, 75% or 100% position while you drag — and to 0% for brightness and contrast. Percentages show the exact value next to each slider.")
      }
    }
    .formStyle(.grouped)
  }
