...
// The live-read invariant: `isEnabled` answers from the system on every
// read, never from a mirror. The fake's backing is mutated behind the
// object's back, exactly what System Settings or sfltool does to the real one.
