...
struct CheckupPlanTests {
  ...
  @Test func worstCaseFieldTimeIsThreeShowingsOfEveryField() {
    // 8 pixel and gray fields at 20 s, white at 10 s, witness at 20 s, each up to three
    // showings, plus one confirmation re-show per plant field at that field's own cap.
